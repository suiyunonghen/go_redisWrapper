...
type
  ...
  TSubMsgInfo = record
    Channel:    PChar;
    Pattern:    Pchar;
    PayLoadArrLen:  Integer;
    PayloadPtr: PValueInterface;
  end;
  PSubMsgInfo = ^TSubMsgInfo;

  TRedisSubscribeMsgCallBack = procedure(redisClient: Pointer;msg: PSubMsgInfo);stdcall;
  ...
  TWndMsgCmd = (MC_Log, MC_StatusCmd, MC_ScanCmd, MC_SelectScan, MC_StringCmd,
    MC_IntCmd,MC_FloatCmd,MC_pipeCmd,MC_BoolCmd,MC_StringSliceCmd,MC_SubscribeMsg);
  ...
  TOnSubScribe = procedure(sender: TObject;channelOrPattern: string;isPattern: Boolean;msgs: array of TValueInterface) of object;
...
{$ENDREGION}
    ...
    procedure Subscribe(channels: array of string;block: Boolean;cmdReturn: TBoolCmdReturn);overload;
    procedure Subscribe(channels: array of string;block: Boolean;cmdReturn: TBoolCmdReturnA);overload;
    procedure Subscribe(channels: array of string;block: Boolean;cmdReturn: TBoolCmdReturnG);overload;

    procedure PSubscribe(channelPatterns: array of string;block: Boolean;cmdReturn: TBoolCmdReturn);overload;
    procedure PSubscribe(channelPatterns: array of string;block: Boolean;cmdReturn: TBoolCmdReturnA);overload;
    procedure PSubscribe(channelPatterns: array of string;block: Boolean;cmdReturn: TBoolCmdReturnG);overload;

    procedure UnSubscribe(channels: array of string;block: Boolean;cmdReturn: TBoolCmdReturn);overload;
    procedure UnSubscribe(channels: array of string;block: Boolean;cmdReturn: TBoolCmdReturnA);overload;
    procedure UnSubscribe(channels: array of string;block: Boolean;cmdReturn: TBoolCmdReturnG);overload;

    procedure PUnsubscribe(channelPatterns: array of string;block: Boolean;cmdReturn: TBoolCmdReturn);overload;
    procedure PUnsubscribe(channelPatterns: array of string;block: Boolean;cmdReturn: TBoolCmdReturnA);overload;
    procedure PUnsubscribe(channelPatterns: array of string;block: Boolean;cmdReturn: TBoolCmdReturnG);overload;
  ...
  private
    FDllHandle: THandle;
  protected
    FInitRedisSdk: procedure(sdkData: PRedisSDKData); cdecl;
    FFreeRedisSdk: procedure(); cdecl;
    FNewRedisConnection: function(cfgData: PRedisConfig): Pointer; cdecl;
    FFreeRedisConnection: procedure(redisClient: Pointer); cdecl;
    FPing: procedure(ClientData: Pointer; block: Boolean;
      resultCallBack: TstatusCmdCallback; params: Pointer); cdecl;
    FTTL: procedure(ClientData: Pointer;Key: Pchar; block: Boolean;
      resultCallBack: TIntCmdCallBack; params: Pointer); cdecl;
    ...
    FMGet: procedure(redisClient: Pointer; Keys: PChar; block: Boolean;
      resultCallBack: TstringSliceCmdCallback; params: Pointer); cdecl;
    FHMGet: procedure(redisClient: Pointer; Key,fields: PChar; block: Boolean;
      resultCallBack: TstringSliceCmdCallback; params: Pointer); cdecl;
    ...
    FScanType: procedure(redisClient: Pointer; cursor: UInt64;
      ...
      resultCallBack: TScanCmdCallback; params: Pointer); cdecl;
    ...
    FRandomKey: procedure(redisClient: Pointer;isByteRetur, block: Boolean;
      resultCallBack: TStringCmdCallback;params: Pointer); cdecl;
    ...
    FIncrByFloat: procedure(redisClient: Pointer; Key: PChar;increment: double; block: Boolean;
      resultCallBack: TfloatCmdCallBack; params: Pointer); cdecl;
    ...
    FSubscribe: procedure(redisClient: Pointer; channels: PChar;block: Boolean; resultCallBack: TIntCmdCallBack;
      subCallBack: TRedisSubscribeMsgCallBack;params: Pointer); cdecl;
    FPSubscribe: procedure(redisClient: Pointer; channels: PChar;block: Boolean; resultCallBack: TIntCmdCallBack;
      subCallBack: TRedisSubscribeMsgCallBack;params: Pointer); cdecl;
    FUnSubscribe: procedure(redisClient: Pointer; channels: PChar;block: Boolean; resultCallBack: TIntCmdCallBack;
      params: Pointer); cdecl;
    FPUnsubscribe: procedure(redisClient: Pointer; channels: PChar;block: Boolean; resultCallBack: TIntCmdCallBack;
      params: Pointer); cdecl;
    FPublish: procedure(redisClient: Pointer; resultCallBack: TIntCmdCallBack;params: Pointer;block: Boolean;
      channel: PChar;value: PValueInterface);cdecl;
    ...
    FNewPipeLiner: function(redisClient,PipeClient: Pointer; txPipeLine: Boolean)
      : Pointer; cdecl;
    FFreePipeLiner: procedure(pipeClient: Pointer); cdecl;
    FPipeExec: procedure(pipeClient: Pointer; block: Boolean;resultCallBack: TPipeExecCallBack;params: Pointer); cdecl;
    ...
    FPExpireAt: procedure(clientData: Pointer;Key: PChar;time: TDateTime;block: Boolean;resultCallBack: TIntCmdCallBack;
      params: Pointer);cdecl;
    FPersist: procedure(clientData: Pointer;Key: PChar;block: Boolean;resultCallBack: TIntCmdCallBack;params: Pointer);cdecl;
    FRenameNX: procedure(clientData: Pointer;key,newKey: Pchar;block: Boolean;resultCallBack: TIntCmdCallBack;params: Pointer);cdecl;
    ...
    FSetXX: procedure(clientData: Pointer;key: Pchar;value: Pointer;byteLen,expiration: Integer;block: Boolean;resultCallBack: TIntCmdCallBack;
      params: Pointer);cdecl;
    FHExists: procedure(clientData: Pointer;key,field: Pchar;block: Boolean;resultCallBack: TIntCmdCallBack;params: Pointer);cdecl;
    ...
    FSMove: procedure(clientData: Pointer;source,destination: PChar;member: Pointer;byteLen: Integer;block: Boolean;resultCallBack: TIntCmdCallBack;
      params: Pointer);cdecl;
    FClientPause: procedure(clientData: Pointer;pauseTimes: integer;block: Boolean;resultCallBack: TIntCmdCallBack;params: Pointer);cdecl;


    FBinCanPrint: function(data: Pointer;dataLen: Integer;scanStyle: byte): Boolean;cdecl;
    FKeys: procedure(cliendData: Pointer;pattern: Pchar;block: Boolean;resultCallBack: TScanCmdCallback;params: Pointer);cdecl;
    FSort: procedure(clientData: Pointer;key: Pchar;sort: PRedisSort;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FSortStore: procedure(clientData: Pointer;key,storeKey: PChar;sort: PRedisSort;block: Boolean;resultCallBack: TIntCmdCallBack;params: Pointer);cdecl;
    FHKeys: procedure(clientData: Pointer;key: Pchar;block: Boolean;resultCallBack: TScanCmdCallback;params: Pointer);cdecl;
    FHVals: procedure(clientData: Pointer;key: PChar;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FHRandField: procedure(clientData: Pointer;key: Pchar;count: Integer;withValues,block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FBRPop: procedure(clientData: Pointer;timeout: Integer;keys: PChar;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FBLPop: procedure(clientData: Pointer;timeout: Integer;keys: PChar;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FLPopCount: procedure(clientData: Pointer;key: Pchar;count: integer;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FLRange: procedure(clientData: Pointer;key: PChar;start,stop: Int64;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FZRange: procedure(clientData: Pointer;key: PChar;start,stop: Int64;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FZRevRange: procedure(clientData: Pointer;key: PChar;start,stop: Int64;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FZRangeByScore: procedure(clientData: Pointer;key: Pchar;opt: PRedisRangeBy;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FZRangeByLex: procedure(clientData: Pointer;key: Pchar;opt: PRedisRangeBy;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FSDiff: procedure(clientData: Pointer;keys: Pchar;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FSUnion: procedure(clientData: Pointer;keys: Pchar;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FSInter: procedure(clientData: Pointer;keys: Pchar;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FSMembers: procedure(clientData: Pointer;key: PChar;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FSPopN: procedure(clientData: Pointer;key: Pchar;count: Int64;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FSRandMemberN: procedure(clientData: Pointer;key: Pchar;count: Int64;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FZRevRangeByScore: procedure(clientData: Pointer;key: Pchar;opt: PRedisRangeBy;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FZRevRangeByLex: procedure(clientData: Pointer;key: Pchar;opt: PRedisRangeBy;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FZRandMember: procedure(ClientData: Pointer;key: Pchar;count: Integer;withScores,block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
    FZDiff: procedure(clientData: Pointer;keys: Pchar;block: Boolean;resultCallBack: TstringSliceCmdCallback;params: Pointer);cdecl;
  ...
  protected
    ...
    procedure DoSubscribeMsg(subMsgs: Pointer);
...
procedure TDxRedisSdkManager.DoSubscribeMsg(subMsgs: Pointer);
var
  msgs: PSubScribeMsg;
  i: integer;
...
begin
  msgs := subMsgs;
  rclient := msgs^.client;
  if Assigned(rclient.FOnSubScribe) then
    rclient.FOnSubScribe(rclient,msgs^.channelOrPattern,msgs^.isPattern,msgs^.values);
  if Length(msgs^.values) > 0 then
  begin
    for i := Low(msgs^.values) to High(msgs^.values) do
      FreeMemory(msgs^.values[i].Value);
  end;
end;
...
begin
  ...
  begin
    ...
    FHMGet := GetProcAddress(FDllHandle, 'HMGet');
    ...
    FSubscribe := GetProcAddress(FDllHandle, 'Subscribe');
    FPSubscribe := GetProcAddress(FDllHandle, 'PSubscribe');
    FUnSubscribe := GetProcAddress(FDllHandle, 'UnSubscribe');
    FPUnsubscribe := GetProcAddress(FDllHandle, 'PUnsubscribe');
    FPublish := GetProcAddress(FDllHandle, 'Publish');
...
procedure TDxRedisClient.UnSubscribe(channels: array of string; block: Boolean;
...
begin
  ...
  begin
    if str = '' then
      str := channels[i]
    else str := str + #13 + channels[i];
  end;
  AtomicIncrement(FRunningCount, 1);
  New(Mnd);
  Mnd^ := TMethod(CmdReturn);
  FRedisSdkManager.FUnSubscribe(FRedisClient, PChar(str),block, boolCmdResult, Mnd);
end;
...
procedure TDxRedisClient.Subscribe(channels: array of string; block: Boolean;
  cmdReturn: TBoolCmdReturn);
var
  Mnd: PMethod;
  str: string;
...
begin
  ...
  New(Mnd);
  Mnd^ := TMethod(CmdReturn);
  FRedisSdkManager.FSubscribe(FRedisClient, PChar(str),block, boolCmdResult,subscribeRecv, Mnd);
end;
...
procedure TDxRedisClient.HMGet(key: string; fields: array of string;
...
begin
  ...
  begin
    if fieldstr = '' then
      ...
      fieldstr := fieldstr + #13 + fields[i];
  end;
  AtomicIncrement(FRunningCount, 1);
  New(Mnd);
  Mnd^ := TMethod(CmdReturn);
  FRedisSdkManager.FHMGet(FRedisClient,PChar(key), PChar(fieldstr),block, stringSliceCmdResult, Mnd);
end;
...
begin
  ...
  New(Mnd);
  Mnd^ := TMethod(ATemp);
  FRedisSdkManager.FHMGet(FRedisClient,PChar(key), PChar(keystr),block, stringSliceCmdResult, Mnd);
end;
...
procedure TDxRedisClient.PSubscribe(channelPatterns: array of string;
  block: Boolean; cmdReturn: TBoolCmdReturn);
var
  Mnd: PMethod;
  str: string;
  i: Integer;
begin
  if Length(channelPatterns) = 0 then
    Exit;
  str := '';
  for i := Low(channelPatterns) to High(channelPatterns) do
  begin
    if str = '' then
      str := channelPatterns[i]
    else str := str + #13 + channelPatterns[i];
  end;
  AtomicIncrement(FRunningCount, 1);
  New(Mnd);
  Mnd^ := TMethod(CmdReturn);
  FRedisSdkManager.FPSubscribe(FRedisClient, PChar(str),block, boolCmdResult,subscribeRecv, Mnd);
end;
...
procedure TDxRedisClient.Publish(channel, value: string; block: Boolean;
...
begin
  ...
  New(Mnd);
  Mnd^ := TMethod(CmdReturn);
  FRedisSdkManager.FPublish(FRedisClient,intCmdResult,Mnd,block,PChar(channel),@v);
end;
...
begin
  AtomicIncrement(FRunningCount, 1);
  ATemp.Data := Pointer(-1);
  ATemp.Code := nil;
  PRedisScanValueCmdReturnA(@ATemp.Code)^ := scanCmdReturn;
  New(Mnd);
  Mnd^.ScanResultType := scanResultValue;
  Mnd^.Method := ATemp;
  FRedisSdkManager.FSScan(FRedisClient, cursor, PChar(Key), PChar(match), count,
...
procedure TDxRedisClient.Publish(channel: string; buffer: Pointer;
...
procedure TDxRedisClient.PUnsubscribe(channelPatterns: array of string; block: Boolean;
  cmdReturn: TBoolCmdReturn);
var
  Mnd: PMethod;
  str: string;
...
begin
  ...
  New(Mnd);
  Mnd^ := TMethod(CmdReturn);
  FRedisSdkManager.FPUnsubscribe(FRedisClient, PChar(str),block, boolCmdResult, Mnd);
end;
